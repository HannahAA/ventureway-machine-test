...
const HowItWorksSection = () => {
    ...
    return (
        <div id="how-it-works" className="flex flex-col w-[80.83vw] max-w-[1164px] mt-[100px] lg:mt-[392px] bg-[#232728] py-6 px-5 lg:px-[78px] rounded-2xl">
            {/* Supporting Sections */}
            ...
            <section className="relative grid grid-cols-3 lg:grid-cols-8 grid-rows-4 h-[587px] gap-y-[23px] mt-[52px] text-left max-w-[757px]"> 
                <div className="hidden lg:block col-start-1 col-end-2 lg:col-end-3 row-start-2 row-end-3 w-max">
                    <h3 className="font-extrabold text-3xl lg:text-6xl text-[#FFFFFF12] rotate-270">Call 01</h3>
                </div>
                <div className="hidden lg:block col-start-1 col-end-2 lg:col-end-3 row-start-4 row-end-5 w-max">
                ...
                <div className="col-start-1 lg:col-start-3 col-end-4 lg:col-end-9 row-start-1 row-end-2 bg-[#1B1C1E] rounded-2xl h-32 p-5 lg:pl-10 lg:py-8 text-white">
                ...
                <div className="col-start-1 lg:col-start-3 col-end-4 lg:col-end-9 row-start-2 row-end-3 bg-[#1B1C1E] rounded-2xl h-32 p-5 lg:pl-10 lg:py-8 text-white">
                ...
                <div className="col-start-1 lg:col-start-3 col-end-4 lg:col-end-9 row-start-3 row-end-4 bg-[#000000] rounded-2xl h-32 lg:h-36 p-5 lg:pl-10 lg:py-8 text-white">
                ...
                <div className="col-start-1 lg:col-start-3 col-end-4 lg:col-end-9 row-start-4 row-end-5 bg-[#000000] rounded-2xl min-h-32 h-fit lg:h-32 p-5 lg:pl-10 lg:py-8 text-white">
