const LandingPageHeroSection = () => {
    return (
        <div className="flex flex-col items-center gap-y-[24px] mt-[50px] lg:mt-[267px]">
            {/* Hero Section */}
            <div className="flex font-heebo font-bold text-6xl lg:text-8xl">
                <h1 className="text-white">Inno</h1>
                <h1 className="text-[#00E5FC]">Hour</h1>
            </div>
            {/* <h1 className="text-white font-bold text-6xl lg:text-8xl">InnoHour</h1> */}
            <div className="flex flex-col lg:flex-row font-bold text-3xl lg:text-5xl gap-2">
            ...
            <div className="flex flex-col lg:flex-row gap-4 lg:gap-6 lg:mt-[53px]">
                ...
                <a href="#chatbox" className="px-[85px] py-[12px] bg-[#ECE9E9] text-[#191919] font-medium text-base rounded-lg shadow hover:bg-gray-300 transition">Chat Now</a>
            </div>
        </div>
    )
}
